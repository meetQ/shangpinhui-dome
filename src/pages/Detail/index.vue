          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" @click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" v-model.number="skuNum" @change="changeSkuNum" class="itxt">
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a href="javascript:" class="mins" @click="skuNum>1? skuNum--:skuName=1">-</a>
              </div>
              <div class="add">
